...
def normalize_workspace_id(value: str | None, *, default: str) -> str:
    ...
    if not _WORKSPACE_PATTERN.fullmatch(workspace_id):
        raise ValueError("Workspace IDs must be 1-64 characters and contain only letters, numbers, underscores, or hyphens.")
    return workspace_id
...
def metadata_matches_workspace(metadata: dict[str, str], workspace_id: str, *, default: str) -> bool:
